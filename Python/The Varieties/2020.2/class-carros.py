...
class Veiculo:
    ...
    def exibir_dados(self):
        ...
        print('Preço do veículo:', self.preco)
...
class Carro(Veiculo):
    ...
    def exibir_dados(self):
        super().exibir_dados() #Chama primeiro o exibir_dados() da classe Veículo.
...
class Caminhao(Veiculo):
    ...
    def exibir_dados(self):
        super().exibir_dados()
        print('Comprimento do Caminhão:', float(self.comprimento), 'metros')
