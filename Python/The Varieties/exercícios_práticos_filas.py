...
EXPLICAÇÃO
    ...
    Para a operação "desenfileirar", fazemos lista.pop(0)
    Para "enfileirar" um elemento, fazemos lista.append(elemento)
...
EXERCICIO 4
    ...
    Definindo uma fila como acima, com listas, faca uma funcao "enfileirar"
...
EXERCICIO 5
    ...
    Faca a funcao "desenfileirar" que remove o elemento do inicio da fila e
...
EXERCICIO 6
    ...
    Implemente a função "tamanho", que recebe uma fila e retorna a
...
EXERCICIO 7
    ...
    Usando o tamanho, podemos definir uma funcao "fila_vazia" que retorna
...
# ----------------------------------------------------------------------
'''
O trecho de código abaixo irá testar a implementação das funções.
