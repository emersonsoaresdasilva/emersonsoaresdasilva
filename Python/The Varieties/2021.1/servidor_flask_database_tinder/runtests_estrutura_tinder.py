...
'''
    ...
    por exemplo maximus = {'nome':'maximus','id':9,'sexo':'homem','buscando':['mulher']}
...
class TestStringMethods(unittest.TestCase):
    ...
    #ficar vazio
    def test_p1_03_adiciona_e_reseta(self):
        #crio um usuário
    ...
    def test_p3_01_match_com_pessoas_invalidas(self):
        #reseto
        i.reseta()
    ...
    def test_p3_02_match_perdido(self):
        #reseto
        i.reseta()
