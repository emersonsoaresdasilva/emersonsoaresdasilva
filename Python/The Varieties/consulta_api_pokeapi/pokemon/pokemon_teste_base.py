...
def verificar_online(desejado):
    ...
    if desejado == "pokeapi":
        if y == "zumbi": raise Exception("Os servidores aparentemente não estão em funcionamento. Estes testes só devem ser executados com o pokeapi on-line e o treinador off-line.")
        if y == "offline": raise Exception("O pokeapi está off-line. Estes testes só devem ser executados com o pokeapi on-line.")
